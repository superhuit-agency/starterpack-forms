...
function register() {
	register_post_type(NAME,
		array(
			'labels' => array(
				'name'                  => _x( 'Forms', 'Post Type General Name', 'supt' ),
				'singular_name'         => _x( 'Form', 'Post Type Singular Name', 'supt' ),
				'menu_name'             => __( 'Forms', 'supt' ),
				'name_admin_bar'        => __( 'Form', 'supt' ),
				'archives'              => __( 'Form Archives', 'supt' ),
				'attributes'            => __( 'Form Attributes', 'supt' ),
				'parent_item_colon'     => __( '', 'supt' ),
				'all_items'             => __( 'All Forms', 'supt' ),
				'add_new_item'          => __( 'Add New Form', 'supt' ),
				'add_new'               => __( 'Add New', 'supt' ),
				'new_item'              => __( 'New Form', 'supt' ),
				'edit_item'             => __( 'Edit Form', 'supt' ),
				'update_item'           => __( 'Update Form', 'supt' ),
				'view_item'             => __( 'View Form', 'supt' ),
				'view_items'            => __( 'View Forms', 'supt' ),
				'search_items'          => __( 'Search Form', 'supt' ),
				'not_found'             => __( 'Not found', 'supt' ),
				'not_found_in_trash'    => __( 'Not found in Trash', 'supt' ),
				'featured_image'        => __( 'Featured Image', 'supt' ),
				'set_featured_image'    => __( 'Set featured image', 'supt' ),
				'remove_featured_image' => __( 'Remove featured image', 'supt' ),
				'use_featured_image'    => __( 'Use as featured image', 'supt' ),
				'insert_into_item'      => __( 'Insert into Form', 'supt' ),
				'uploaded_to_this_item' => __( 'Uploaded to this Form', 'supt' ),
				'items_list'            => __( 'Form list', 'supt' ),
				'items_list_navigation' => __( 'Form list navigation', 'supt' ),
				'filter_items_list'     => __( 'Filter Form list', 'supt' ),
			),
			'label'                 => __( 'Form', 'supt' ),
...
function register_options_page() {
	...
	acf_add_options_sub_page(array(
		'page_title' 	=> __('Forms settings', 'supt'),
...
function register_columns_fields( $columns ) {
	return array_merge(
		...
		array( COLUMN_NOTIFICATION_NAME => __('Notification email', 'supt') ),
		array( COLUMN_FIELDS_NAME => __('Fields', 'supt') ),
